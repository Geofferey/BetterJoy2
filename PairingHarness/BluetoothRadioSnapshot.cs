...
// process - referencing the evolving main project here would reintroduce exactly the coupling
// this is meant to rule out, and would silently change the harness's behavior on every future
// edit to the real BluetoothRadio.cs. If BetterJoyForCemu/BluetoothRadio.cs changes in a way
// that matters for this comparison, refresh this file manually (see run.md).
